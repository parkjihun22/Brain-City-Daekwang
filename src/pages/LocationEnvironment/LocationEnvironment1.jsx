...
const LocationSection = [
  {
    img: section2Image1,
    titleText:
      "미래가치를 높여주는<br />평택반도체 벨트 ",
    contentText:
      "첨단시스템 반도체 클러스터(계획), 평택반도체 클러스터 일반산업단지<br />L자형 반도체벨트의 비전을 선점하는<br />독보적 프리미엄 브랜드",
  },
  {
    img: section2Image2,
    titleText: "차량 10분내 대형병원 인접<br />의세권을 누리릴 수 있는 프리미엄",
    contentText:
      "평택의 의세권을 책임지는<br />오래된 의료경력을 갖고 있는<br /> 500병상 규모 명지병원 인접",
  },
  {
    img: section2Image3,
  ...
  {
    img: section2Image5,
    titleText: "3,724세대 모아엘가<br />대단지 프리미엄 ",
    contentText: "총 3,724세대 모아엘가 메가타운으로 <br / >누리는 대단지 프리미엄과<br / >지구 내 초등학교 부지(계획), 도서관 및 체육시설 ",
  },
  {
    img: section2Image6,
    titleText:
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>브레인시티 메디스파크 로제비앙모아엘가 - 입지환경</title>
        <meta
          name="description"
          content="브레인시티 메디스파크 로제비앙모아엘가의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
"
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://leecols.kr/LocationEnvironment/intro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="브레인시티 메디스파크 로제비앙모아엘가 - 입지환경"
        />
        <meta
...
"
        ...
        <meta
          property="og:url"
          content="https://leecols.kr/LocationEnvironment/intro"
        />
          ...
          {`
										{
											...
											"@type": "WebPage",
											"name": "브레인시티 메디스파크 로제비앙모아엘가 - 입지환경",
											"description": "브레인시티 메디스파크 로제비앙모아엘가의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
",
											"url": "https://leecols.kr/LocationEnvironment/intro"
										}
										`}
        </script>
      </Helmet>
      ...
      <h1 className={styles.screenReaderOnly}>
        브레인시티 메디스파크 로제비앙모아엘가 - 입지안내
      </h1>
      <p className={styles.screenReaderOnly}>
        브레인시티 메디스파크 로제비앙모아엘가의 입지 정보를 확인하세요. 뛰어난 교통망, 생활
      ...
      <div className={styles.textBox}>
        ...
        <div>살수록 높아질 모아엘가</div>
        <div>도시를 압도할 자부심 모아엘가</div>
      </div>

      <img
        src={page1}
        className={styles.image2}
        alt="브레인시티 메디스파크 로제비앙모아엘가입지환경-image1"
      />
      ...
      <div className={styles.commonBox}>
        <div className={styles.notice}>
          ※본 홍보물의 내용과 지역도는 소비자의 이해를 돕기 위한 것으로, 개발 예정•계획 및 교통, 학교 계획 등에 관한 사항은 해당 기관의 아래 자료를 토대로 제작되었습니다. 사업계획 및 일정은 개발계획별 사업주체에 의해 변경될 수 있으며, 브레인시티 메디스파크 로제비앙모아엘가 사업주체 및 시공사와 무관합니다.
        </div>
        <div className={styles.notice}>
