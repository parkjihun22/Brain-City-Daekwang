...
const handleInputChange = (e) => {
 ...
 const newsList = [
  {
    id: 1,
    title: "대광건영∙모아건설산업, 평택 ‘브레인시티 메디스파크 모아엘가’ 분양",
    excerpt:
      "㈜대광건영과 모아건설산업㈜ 컨소시엄이 평택 브레인시티에 대규모 주거단지 ‘브레인시티 메디스파크 모아엘가’를 공급한다. 단지는 장안동 일반산업단지 공동 6블록에 지하 2층~지상 35층, 10개 동 규모로 들어서며 전용 59~101㎡ 총 1215가구로 조성된다. 분양가상한제가 적용돼 합리적인 분양가가 기대된다.",
    date: "2025. 7. 21.",
  ...
  },
  {
    ...
    excerpt:
      "평택 브레인시티 중심 입지에 조성되는 ‘브레인시티 메디스파크 모아엘가’가 실수요자와 투자자들의 관심을 끌고 있다. 단지는 의료·교육·교통·자연 인프라를 두루 갖춘 핵심 입지에 들어서며, 지하 2층~지상 35층, 10개 동, 총 1215가구 규모다. 대광건영과 모아건설산업 컨소시엄이 시공을 맡아 안정성과 브랜드 가치를 더했다.",
    date: "2024. 10. 10.",
  ...
  },
  {
    ...
    excerpt:
      "대광건영이 평택 ‘브레인시티 메디스파크 모아엘가’ 분양 과정에서 마케팅을 최소화해 청약 미달을 의도했다는 ‘깜깜이 분양’ 논란이 불거졌다. 실제로 지난 8~9일 진행된 1·2순위 청약에서 1200가구 모집에 단 38명만 신청, 평균 경쟁률 0.03대 1로 역대 최저 수준을 기록했다. 이는 추후 조건 변경 후 선착순 분양을 노린 전략이라는 의혹을 낳고 있다.",
    date: "2024. 10. 10.",
  ...
  {
    id: 4,
    title: "브레인시티 메디스파크 모아엘가, 끝내 청약 미달",
    excerpt:
      "대광건영·모아건설산업이 평택에 공급하는 ‘브레인시티 메디스파크 모아엘가’가 청약에서 미달을 기록했다. 한국부동산원에 따르면 1·2순위 청약 결과 1200가구 모집에 38명만 신청, 전 타입이 마감에 실패했다. 전용 59㎡A형은 90가구에 15명, 84㎡A형은 560가구에 14명만 신청하는 등 전 주택형에서 수요 부족이 드러나며 향후 분양 전략에 관심이 쏠린다.",
    date: "2024. 10. 10.",
