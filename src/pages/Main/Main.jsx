  ...
  return (
    <>
      <Helmet>
        ...
        <title>▪브레인시티 메디스파크 로제비앙모아엘가</title>
        <meta
          name="description"
          content="브레인시티메디스파크로제비앙모아엘가ㅣ☎️(대표)1533-8848ㅣ브레인시티로제비앙모아엘가ㅣ견본주택ㅣ모델하우스ㅣ위치ㅣ청약ㅣ분양ㅣ분양가ㅣ공급정보ㅣ잔여세대문의ㅣ고객센터ㅣ방문예약"
        />
        <meta name="keywords" content="브레인시티 메디스파크 로제비앙, 브레인시티로제비앙모아엘가, 브레인시티로제비앙모아엘가모델하우스" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://leecols.kr/" />
        ...
        <meta
          property="og:title"
          content="▪브레인시티 메디스파크 로제비앙모아엘가"
        />
        <meta
          property="og:description"
          content="브레인시티메디스파크로제비앙모아엘가ㅣ☎️(대표)1533-8848ㅣ브레인시티로제비앙모아엘가ㅣ견본주택ㅣ모델하우스ㅣ위치ㅣ청약ㅣ분양ㅣ분양가ㅣ공급정보ㅣ잔여세대문의ㅣ고객센터ㅣ방문예약"
        />
        <meta property="og:url" content="https://leecols.kr/" />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://leecols.kr/Main1.png" // 실제 메인 이미지 URL로 변경하세요.
        />
        ...
        <meta
          name="twitter:image"
          content="https://leecols.kr/Main1.png" // 실제 이미지 URL로 변경하세요.
        />
          ...
          {`
      {
        ...
        "name": "브레인시티 메디스파크 로제비앙모아엘가",
        "description": "브랜드 평판 1위 프리미엄 아파트. 방문 예약 시 신세계상품권 증정 등 다양한 혜택을 제공합니다.",
        "url": "https://leecols.kr/",
        "image": "https://leecols.kr/Main1.png",
        "telephone": "1533-8848",
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "경기도 평택 은화삼지구",
          "addressLocality": "평택",
          "addressRegion": "경기도",
          "postalCode": "우편번호"
        }
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img
              ...
              alt="브레인시티 메디스파크 로제비앙모아엘가-mainimage1"
            />
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  ...
                  광역교통망의 중심
                  <br />- 모두를 누리는 브레인시티 메디스파크 로제비앙모아엘가
                </div>
              ...
              <div className={styles.menuBox}>
                <img
                  src={section1_Image1}
                  alt="브레인시티 메디스파크 로제비앙모아엘가 브랜드소개-image2"
                />
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.subTitle}>
                  ...
                  <div className={styles.subText}>
                    ...
                    <br />
                    브레인시티 메디스파크 로제비앙모아엘가가 함께합니다
                  </div>
                </div>
              </div>
              <img
                src={section8Img3}
                alt="브레인시티 메디스파크 로제비앙모아엘가 입지환경소개-image2"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="브레인시티 메디스파크 로제비앙모아엘가 아파트 조감도-image3"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="브레인시티 메디스파크 로제비앙모아엘가 브랜드소개-image4"
                />
                <div className={styles.text1}>브레인시티 메디스파크 로제비앙모아엘가</div>
...
<div className={styles.pcVisitContainer}>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="브레인시티 메디스파크 로제비앙모아엘가 오시는길안내-image1" />
            </div>
          </div> */}
  ...
  <img
    src={mobileImageMain}
    className={styles.mainImage}
    alt="브레인시티 메디스파크 로제비앙모아엘가 mobilemain-image1"
  />
  <div className={styles.overlay}></div>
        ...
        2단지
         ...
         <section className={styles.darkSection}>
          ...
          {/* <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="브레인시티 메디스파크 로제비앙모아엘가 mobile입지안내-image1"
            />
          </div> */}
          ...
          {/* <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 브레인시티 메디스파크 로제비앙모아엘가에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="브레인시티 메디스파크 로제비앙모아엘가 mobile조감도-image1"
            />
          </div> */}
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="브레인시티 메디스파크 로제비앙모아엘가 브랜드소개 mobile-image5"
              />
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="브레인시티 메디스파크 로제비앙모아엘가 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
