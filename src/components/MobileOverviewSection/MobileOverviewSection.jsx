...
const items = [
  {
    ...
    content: (
      <ul className={styles.detailList}>
        <li>
          <strong>사업명</strong>
          <span>브레인시티 메디스파크 로제비앙모아엘가</span>
        </li>
        <li>
          <strong>대지위치</strong>
          <span>
            [1단지] 평택시 처인구 남동 산126-13<br />
            [2단지] 평택시 처인구 남동 산126-1일원<br />
            [3단지] 평택시 처인구 남동 243일원
          </span>
        </li>
        <li>
          <strong>건축규모</strong>
...
function PremiumSlider() {
  const slides = [
    {
      img: slide1,
      title: "미래가치를 높여주는 평택반도체벨트",
      desc:
        "삼성 · SK하이닉스 반도체 클러스터(계획), <br />평택반도체 클러스터 일반산업단지 L자형 반도체벨트의 비전",
    },
    {
      img: slide2,
    ...
    {
      img: slide5,
      title: "3,724세대 모아엘가 대단지 프리미엄",
      desc:
        "총 3,724세대 브레인시티 메디스파크 로제비앙 메가타운으로 찾아옵니다",
    },
    {
      img: slide6,
      title: "확정된 미래가치 보장",
